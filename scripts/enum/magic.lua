...
xi.magic.spell =
{
    ...
    -- Parentheses denote a trust planned for its aquisition method to be changed.
    SHANTOTTO             =  896,
    NAJI                  =  897,
    KUPIPI                =  898,
    EXCENMILLE            =  899,
    ...
    AJIDO_MARUJIDO        =  904,
    TRION                 =  905,
    ZEID                  =  906, -- Nation 5-1: Darkness Rising/The Ruins of Fei'Yin/The Final Seal
    LION                  =  907, -- RoV 1-2-2: At the Heavens' Door
    TENZEN                =  908, -- PM3-2: A Vessel Without a Captain
    MIHLI_ALIAPOH         =  909, -- (Records of Eminence)
    VALAINERAL            =  910, -- (Records of Eminence)
    JOACHIM               =  911, -- (Records of Eminence)
    NAJA_SALAHEEM         =  912, -- ToAU 11: Imperial Schemes
    PRISHE                =  913,
    ULMIA                 =  914,
    SHIKAREE_Z            =  915,
    CHERUKIKI             =  916,
    ...
    RAINEMARD             =  920,
    INGRID                =  921,
    LEHKO_HABHOKA         =  922, -- Quest: Knot Quite There
    NASHMEIRA             =  923,
    ZAZARG                =  924,
    OVJANG                =  925, -- (Assault)
    MNEJING               =  926, -- (Assault)
    SAKURA                =  927, -- (Fields of Valor)
    LUZAF                 =  928, -- ToAU 15: The Black Coffin
    NAJELITH              =  929, -- Quest: When the Bow Breaks
    ALDO                  =  930,
    MOOGLE                =  931,
    FABLINIX              =  932,
    MAAT                  =  933,
    DOMINA_SHANTOTTO      =  934, -- Quest: Curses, Foiled A-Golem!? (change once ASA confirmed as finished)
    STAR_SIBYL            =  935, -- Nation 4-1: Magicite
    KARAHA_BARUHA         =  936, -- Nation 4-1: Magicite
    CID                   =  937, -- (Sparks of Eminence)
    GILGAMESH             =  938, -- (Sparks of Eminence)
    AREUHAT               =  939, -- Rhapsody in Emerald, Purchase from Curio V.M.
    SEMIH_LAFIHNA         =  940,
    ELIVIRA               =  941, -- (Allied Notes)
    NOILLURIE             =  942, -- (Allied Notes)
    LHU_MHAKARACCA        =  943, -- (Allied Notes)
    FERREOUS_COFFIN       =  944, -- (Sparks of Eminence)
    LILISETTE             =  945,
    MUMOR                 =  946,
    UKA_TOTLIHN           =  947,
    KLARA                 =  948,
    ROMAA_MIHGO           =  949,
    KUYIN_HATHDENNA       =  950, -- Purchase from Green Thumb Moogle
    RAHAL                 =  951, -- (Conquest Points)
    KORU_MORU             =  952, -- (Fields of Valor)
    PIEUJE_UC             =  953,
    ...
    RUGHADJEEN            =  960, -- Quest: Saga of the Skyserpent
    KUKKI_CHEBUKKI        =  961, -- (Conquest Points)
    MARGRET               =  962, -- (Bayld)
    CHACHAROON            =  963,
    LHE_LHANGAVO          =  964, -- SoA 4-1-4: Ministerial Whispers
    ARCIELA               =  965,
    MAYAKOV               =  966, -- WotG 4: The Queen of the Dance
    QULTADA               =  967, -- (Sparks of Eminence)
    ADELHEID              =  968, -- (Records of Eminence)
    AMCHUCHU              =  969, -- (Bayld)
    BRYGID                =  970, -- Quest: Brygid the Stylist Returns
    MILDAURION            =  971, -- PM8-4 when CoP ring is chosen.
    HALVER                =  972,
    RONGELOUTS            =  973, -- Quest: Steamed Rams
    LEONOYNE              =  974, -- (Allied Notes)
    MAXIMILIAN            =  975, -- (Allied Notes)
    KAYEEL_PAYEEL         =  976, -- (Allied Notes)
    ROBEL_AKBEL           =  977, -- WotG 12: Affairs of State
    KUPOFRIED             =  978,
    SELHTEUS              =  979,
    YORAN_ORAN_UC         =  980,
    SYLVIE_UC             =  981,
    ...
    AUGUST                =  984,
    ROSULATIA             =  985,
    TEODOR                =  986, -- Quest: Flavors of Our Lives
    ULLEGORE              =  987, -- (need to add)
    MAKKI_CHEBUKKI        =  988, -- (Conquest Points)
    KING_OF_HEARTS        =  989, -- (Sparks of Eminence)
    MORIMAR               =  990, -- (Bayld)
    DARRCUILN             =  991, -- SoA 4-2-4: Darrcuiln
    AAHM                  =  992,
    AAEV                  =  993,
    AAMR                  =  994,
    AATT                  =  995,
    ...
    ARCIELA_II            = 1017,
    IROHA_II              = 1018,
    SHANTOTTO_II          = 1019, -- Quest: Curses, Foiled A-Golem!?
}
