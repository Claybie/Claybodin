...
xi.magic.spell =
{
    ...
    AJIDO_MARUJIDO        =  904,
    TRION                 =  905,
    ZEID                  =  906, -- Cipher awarded for completing Nation mission 5-1, any nation
    LION                  =  907, -- Cipher awarded for completing RoV mission 1-7: At the Heavens' Door
    TENZEN                =  908, -- (Conquest Points)
    ...
    RAINEMARD             =  920,
    INGRID                =  921,
    LEHKO_HABHOKA         =  922, -- Cipher awarded for completing quest: Knot Quite There
    NASHMEIRA             =  923,
    ZAZARG                =  924,
    OVJANG                =  925, -- (Assault)
    MNEJING               =  926, -- (Assault)
    ...
    FABLINIX              =  932,
    MAAT                  =  933,
    DOMINA_SHANTOTTO      =  934, -- Cipher awarded for completing quest: Curses, Foiled A-Golem!?
    STAR_SIBYL            =  935, -- Cipher awarded for completing Nation mission 4-1, any nation
    KARAHA_BARUHA         =  936, -- Cipher awarded for completing Nation mission 4-1, any nation
    CID                   =  937, -- (Sparks of Eminence)
    GILGAMESH             =  938, -- (Sparks of Eminence)
    AREUHAT               =  939, -- Cipher purchased from Curio V.M. scrolls if in posession of Rhapsody in Emerald
    SEMIH_LAFIHNA         =  940,
    ...
    KLARA                 =  948,
    ROMAA_MIHGO           =  949,
    KUYIN_HATHDENNA       =  950, -- Cipher purchased from Green Thumb Moogle
    ...
    ARCIELA               =  965,
    MAYAKOV               =  966, -- Cipher awarded for completing WotG mission 4 The Queen of the Dance
    ...
    ROBEL_AKBEL           =  977, -- Cipher awarded for completing WotG mission 12 Affairs of State
    KUPOFRIED             =  978,
    SELHTEUS              =  979,
    YORAN_ORAN_UC         =  980,
    SYLVIE_UC             =  981,
    ...
    AUGUST                =  984,
    ROSULATIA             =  985,
    TEODOR                =  986, -- Cipher awarded for completing quest: Flavors of Our Lives
    ULLEGORE              =  987, -- (need to add)
    MAKKI_CHEBUKKI        =  988, -- (Conquest Points)
    KING_OF_HEARTS        =  989, -- (Sparks of Eminence)
    MORIMAR               =  990, -- (Bayld)
    DARRCUILN             =  991, -- Cipher awarded for completing SoA M4-2-4
    AAHM                  =  992,
    AAEV                  =  993,
    AAMR                  =  994,
    AATT                  =  995,
    ...
    ARCIELA_II            = 1017,
    IROHA_II              = 1018,
    SHANTOTTO_II          = 1019, -- Cipher awarded for completing quest: Curses, Foiled A-Golem!?
}
