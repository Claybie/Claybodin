...
local optionToItem =
{
    ...
    [12] = { -- Alter Ego Extravaganza Trusts
        [10133] = { cost = 2500, id = xi.items.CIPHER_OF_F_COFFINS_ALTER_EGO }, -- F. Coffin
        [10138] = { cost =  750, id = xi.items.CIPHER_OF_CIDS_ALTER_EGO }, -- Cid
        [10148] = { cost = 1500, id = xi.items.CIPHER_OF_GILGAMESHS_ALTER_EGO }, -- Gilgamesh
        [10152] = { cost = 1000, id = xi.items.CIPHER_OF_QULTADAS_ALTER_EGO }, -- Qultada
        [10181] = { cost =  500, id = xi.items.CIPHER_OF_KINGS_ALTER_EGO }, -- King
	[10149] = { cost = 2000, id = 10149 }, -- Areuhat 
    },
