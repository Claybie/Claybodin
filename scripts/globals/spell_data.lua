...
xi.magic.spell =
{
    ...
    AJIDO_MARUJIDO        =  904,
    TRION                 =  905,
    ZEID                  =  906, -- Cipher awarded for completing 5-1 for any nation
    LION                  =  907, -- Cipher awarded for completing RoV 1-7
    TENZEN                =  908, -- (need to change)
    MIHLI_ALIAPOH         =  909, -- (need to change)
    VALAINERAL            =  910, -- (need to change)
    JOACHIM               =  911, -- (need to change)
    NAJA_SALAHEEM         =  912, -- Cipher awarded for completing Aht Uhrgan Mission 11
    PRISHE                =  913, 
    ULMIA                 =  914,
    SHIKAREE_Z            =  915,
    CHERUKIKI             =  916,
    ...
    RAINEMARD             =  920,
    INGRID                =  921,
    LEHKO_HABHOKA         =  922, -- Cipher awarded for completing Knot Quite There quest
    NASHMEIRA             =  923,
    ZAZARG                =  924,
    OVJANG                =  925, -- (need to change)
    MNEJING               =  926, -- (need to change)
    SAKURA                =  927, -- (need to change)
    LUZAF                 =  928, -- Cipher awarded for completing Aht Urghan Mission 15
    NAJELITH              =  929, -- (need to add)
    ALDO                  =  930,
    MOOGLE                =  931,
    FABLINIX              =  932,
    MAAT                  =  933,
    DOMINA_SHANTOTTO      =  934, -- Spell awarded for completing Quest: Curses, Foiled A-Golem!?
    STAR_SIBYL            =  935, -- Ciper awarded for completing 4-1 for any nation
    KARAHA_BARUHA         =  936, -- (need to add)
    CID                   =  937, -- (need to change)
    GILGAMESH             =  938, -- (need to change)
    AREUHAT               =  939, -- (need to add)
    SEMIH_LAFIHNA         =  940,
    ELIVIRA               =  941, -- (need to change)
    NOILLURIE             =  942, -- (need to change)
    LHU_MHAKARACCA        =  943, -- (need to change)
    FERREOUS_COFFIN       =  944, -- (need to change)
    LILISETTE             =  945,
    MUMOR                 =  946,
    UKA_TOTLIHN           =  947, -- (need to add)
    KLARA                 =  948,
    ROMAA_MIHGO           =  949,
    KUYIN_HATHDENNA       =  950, -- (need to add)
    RAHAL                 =  951, -- (need to change)
    KORU_MORU             =  952, -- (need to change)
    PIEUJE_UC             =  953,
    ...
    KUKKI_CHEBUKKI        =  961, -- (need to change)
    MARGRET               =  962, -- (need to change)
    CHACHAROON            =  963,
    LHE_LHANGAVO          =  964, -- (need to add)
    ARCIELA               =  965,
    MAYAKOV               =  966, -- (need to add)
    QULTADA               =  967, -- (need to change)
    ADELHEID              =  968, -- (need to change)
    AMCHUCHU              =  969, -- (need to change)
    BRYGID                =  970, -- (need to add)
    MILDAURION            =  971, -- (need to add)
    HALVER                =  972,
    RONGELOUTS            =  973, -- (need to add)
    LEONOYNE              =  974, -- (need to change)
    MAXIMILIAN            =  975, -- (need to change)
    KAYEEL_PAYEEL         =  976, -- (need to change)
    ROBEL_AKBEL           =  977, -- (need to add)
    KUPOFRIED             =  978,
    SELHTEUS              =  979,
    YORAN_ORAN_UC         =  980,
    SYLVIE_UC             =  981,
    ...
    AUGUST                =  984,
    ROSULATIA             =  985,
    TEODOR                =  986, -- (need to add)
    ULLEGORE              =  987, -- (need to add)
    MAKKI_CHEBUKKI        =  988, -- (need to change)
    KING_OF_HEARTS        =  989, -- (need to change)
    MORIMAR               =  990, -- (need to change)
    DARRCUILN             =  991, -- (need to add)
    AAHM                  =  992,
    AAEV                  =  993,
    AAMR                  =  994,
    AATT                  =  995,
    ...
    ARCIELA_II            = 1017,
    IROHA_II              = 1018,
    SHANTOTTO_II          = 1019, -- Awarded for completing Quest: Curses, Foiled A-Golem!?
}
